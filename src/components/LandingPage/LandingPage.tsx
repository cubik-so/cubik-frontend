...
const LandingPage = () => {
  ...
  return (
    <Container maxW="7xl" py={{ base: '4vh', md: '6vh' }} px="0">
      <VStack
        textAlign="center"
        mx="auto"
        maxW={'4xl'}
      ...
      >
        <Box
          textStyle={{ base: 'title5', md: 'title2' }}
        ...
        <Box
          as="p"
          zIndex="1"
          textStyle={{ base: 'headline2', md: 'display3', lg: 'display1' }}
        >
          Fund Public Goods Through Community Voting on Solana
        </Box>
        <Center gap={{ base: '0.6rem', md: '1rem' }} py="1rem">
          <Button
            onClick={() => {
        ...
        <Center
          ...
          zIndex="0"
          minH={{ base: '300px', md: '800px' }}
        >
          <SplineAsset />
        </Center>
      </VStack>
      <VStack background="#010109" overflow="hidden" spacing="0" w="100%">
        <Center
          zIndex={'1'}
          w="100%"
          rounded="50px 50px 0px 0px"
          height={{ base: '24rem', md: '18rem' }}
          bgGradient="linear-gradient(180.14deg, #FF5CC9 0.12%, #04010A 99.88%)"
          backgroundColor={
            'linearGradient(180.14deg, #FF5CC9 0.12%, #010109 90%)'
          }
          position="relative"
          overflow={'hidden'}
          _before={{
        ...
        >
          ...
          >
            ...
            >
              With Cubik, you can create a project and start receiving funding
              in minutes.
            </Box>
          </VStack>
        </Center>
        ...
        >
          <Stack
            ...
            position={'relative'}
            backgroundColor="#00010A20"
            border="1px solid rgba(245, 78, 189, 0.08)"
            rounded="16px"
            textAlign={'start'}
            overflow="hidden"
            alignItems="start"
          ...
          >
            ...
            <VStack flex="50%" zIndex={'1'} gap="3rem" alignItems="start">
              <VStack alignItems="start">
                <Box color="#D645A6" as="p" textStyle="title6">
                  01
                </Box>
        ...
        <Center
          ...
          height="full"
          pb={'3rem'}
          bgGradient="linear-gradient(0deg, #FF5CC9 0.12%, #010109 90%)"
          position="relative"
          overflow={'hidden'}
          flexDir="column"
          gap="4rem"
        ...
        >
          ...
          >
            <VStack alignItems={'start'} zIndex="1">
              ...
              <Box textStyle={{ base: 'body3', md: 'body2' }} color="#D6D6D6">
              ...
              <Center w="full" py="1rem">
                <HStack
                  ...
                  rounded={'full'}
                >
                  <FormControl bg="black" rounded="full">
                    <Input
                      bg="#07070F !important"
                      variant={'solid'}
                      borderWidth={0}
                  ...
                  <FormControl w={{ base: '100%', md: '40%' }}>
                    ...
                    >
                      {state === 'success' ? 'check icon' : 'Submit'}
                    </Button>
                  </FormControl>
                </HStack>
              </Center>
